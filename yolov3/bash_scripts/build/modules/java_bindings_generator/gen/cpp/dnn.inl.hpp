...
#include "/home/k8smaster/github/tools/yolov3/bash_scripts/opencv-master/modules/dnn/misc/java/src/cpp/dnn_converters.hpp"
#include "/home/k8smaster/github/tools/yolov3/bash_scripts/opencv-master/modules/dnn/include/opencv2/dnn/dict.hpp"
#include "/home/k8smaster/github/tools/yolov3/bash_scripts/opencv-master/modules/dnn/include/opencv2/dnn/dnn.hpp"
#include "/home/k8smaster/github/tools/yolov3/bash_scripts/opencv-master/modules/dnn/include/opencv2/dnn/utils/inference_engine.hpp"
  ...
  (JNIEnv* env, jclass , jstring model, jstring config)
{
    ...
    try {
        ...
        const char* utf_model = env->GetStringUTFChars(model, 0); String n_model( utf_model ? utf_model : "" ); env->ReleaseStringUTFChars(model, utf_model);
        const char* utf_config = env->GetStringUTFChars(config, 0); String n_config( utf_config ? utf_config : "" ); env->ReleaseStringUTFChars(config, utf_config);
        Ptr<cv::dnn::ClassificationModel> _retval_ = makePtr<cv::dnn::ClassificationModel>( n_model, n_config );
        return (jlong)(new Ptr<cv::dnn::ClassificationModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
  ...
  (JNIEnv* env, jclass , jstring model)
{
    ...
    try {
        LOGD("%s", method_name);
        const char* utf_model = env->GetStringUTFChars(model, 0); String n_model( utf_model ? utf_model : "" ); env->ReleaseStringUTFChars(model, utf_model);
        Ptr<cv::dnn::ClassificationModel> _retval_ = makePtr<cv::dnn::ClassificationModel>( n_model );
        return (jlong)(new Ptr<cv::dnn::ClassificationModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong network_nativeObj)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::dnn::ClassificationModel> _retval_ = makePtr<cv::dnn::ClassificationModel>( (*(cv::dnn::Net*)network_nativeObj) );
        return (jlong)(new Ptr<cv::dnn::ClassificationModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jstring model, jstring config)
{
    ...
    try {
        ...
        const char* utf_model = env->GetStringUTFChars(model, 0); String n_model( utf_model ? utf_model : "" ); env->ReleaseStringUTFChars(model, utf_model);
        const char* utf_config = env->GetStringUTFChars(config, 0); String n_config( utf_config ? utf_config : "" ); env->ReleaseStringUTFChars(config, utf_config);
        Ptr<cv::dnn::DetectionModel> _retval_ = makePtr<cv::dnn::DetectionModel>( n_model, n_config );
        return (jlong)(new Ptr<cv::dnn::DetectionModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
  ...
  (JNIEnv* env, jclass , jstring model)
{
    ...
    try {
        LOGD("%s", method_name);
        const char* utf_model = env->GetStringUTFChars(model, 0); String n_model( utf_model ? utf_model : "" ); env->ReleaseStringUTFChars(model, utf_model);
        Ptr<cv::dnn::DetectionModel> _retval_ = makePtr<cv::dnn::DetectionModel>( n_model );
        return (jlong)(new Ptr<cv::dnn::DetectionModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong network_nativeObj)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::dnn::DetectionModel> _retval_ = makePtr<cv::dnn::DetectionModel>( (*(cv::dnn::Net*)network_nativeObj) );
        return (jlong)(new Ptr<cv::dnn::DetectionModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jstring model, jstring config)
{
    ...
    try {
        ...
        const char* utf_model = env->GetStringUTFChars(model, 0); String n_model( utf_model ? utf_model : "" ); env->ReleaseStringUTFChars(model, utf_model);
        const char* utf_config = env->GetStringUTFChars(config, 0); String n_config( utf_config ? utf_config : "" ); env->ReleaseStringUTFChars(config, utf_config);
        Ptr<cv::dnn::KeypointsModel> _retval_ = makePtr<cv::dnn::KeypointsModel>( n_model, n_config );
        return (jlong)(new Ptr<cv::dnn::KeypointsModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
  ...
  (JNIEnv* env, jclass , jstring model)
{
    ...
    try {
        LOGD("%s", method_name);
        const char* utf_model = env->GetStringUTFChars(model, 0); String n_model( utf_model ? utf_model : "" ); env->ReleaseStringUTFChars(model, utf_model);
        Ptr<cv::dnn::KeypointsModel> _retval_ = makePtr<cv::dnn::KeypointsModel>( n_model );
        return (jlong)(new Ptr<cv::dnn::KeypointsModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong network_nativeObj)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::dnn::KeypointsModel> _retval_ = makePtr<cv::dnn::KeypointsModel>( (*(cv::dnn::Net*)network_nativeObj) );
        return (jlong)(new Ptr<cv::dnn::KeypointsModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jlong layer_nativeObj, jint numParam)
{
    ...
    try {
        LOGD("%s", method_name);
        cv::dnn::Net* me = (cv::dnn::Net*) self; //TODO: check for NULL
        cv::Mat _retval_ = me->getParam( (*(cv::dnn::DictValue*)layer_nativeObj), (int)numParam );
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jlong layer_nativeObj)
{
    ...
    try {
        LOGD("%s", method_name);
        cv::dnn::Net* me = (cv::dnn::Net*) self; //TODO: check for NULL
        cv::Mat _retval_ = me->getParam( (*(cv::dnn::DictValue*)layer_nativeObj) );
        return (jlong) new cv::Mat(_retval_);
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jstring model, jstring config)
{
    ...
    try {
        ...
        const char* utf_model = env->GetStringUTFChars(model, 0); String n_model( utf_model ? utf_model : "" ); env->ReleaseStringUTFChars(model, utf_model);
        const char* utf_config = env->GetStringUTFChars(config, 0); String n_config( utf_config ? utf_config : "" ); env->ReleaseStringUTFChars(config, utf_config);
        Ptr<cv::dnn::SegmentationModel> _retval_ = makePtr<cv::dnn::SegmentationModel>( n_model, n_config );
        return (jlong)(new Ptr<cv::dnn::SegmentationModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
  ...
  (JNIEnv* env, jclass , jstring model)
{
    ...
    try {
        LOGD("%s", method_name);
        const char* utf_model = env->GetStringUTFChars(model, 0); String n_model( utf_model ? utf_model : "" ); env->ReleaseStringUTFChars(model, utf_model);
        Ptr<cv::dnn::SegmentationModel> _retval_ = makePtr<cv::dnn::SegmentationModel>( n_model );
        return (jlong)(new Ptr<cv::dnn::SegmentationModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong network_nativeObj)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::dnn::SegmentationModel> _retval_ = makePtr<cv::dnn::SegmentationModel>( (*(cv::dnn::Net*)network_nativeObj) );
        return (jlong)(new Ptr<cv::dnn::SegmentationModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jlong frame_nativeObj, jlong detections_mat_nativeObj, jlong confidences_mat_nativeObj)
{
    ...
    try {
        ...
        std::vector<float> confidences;
        Mat& confidences_mat = *((Mat*)confidences_mat_nativeObj);
        Ptr<cv::dnn::TextDetectionModel>* me = (Ptr<cv::dnn::TextDetectionModel>*) self; //TODO: check for NULL
        Mat& frame = *((Mat*)frame_nativeObj);
...
//
//  native support for java finalize()
//  static void Ptr<cv::dnn::TextDetectionModel>::delete( __int64 self )
//
...
JNIEXPORT void JNICALL Java_org_opencv_dnn_TextDetectionModel_delete
  (JNIEnv*, jclass, jlong self)
{
    delete (Ptr<cv::dnn::TextDetectionModel>*) self;
}
  ...
  (JNIEnv* env, jclass , jlong network_nativeObj)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::dnn::TextDetectionModel_DB> _retval_ = makePtr<cv::dnn::TextDetectionModel_DB>( (*(cv::dnn::Net*)network_nativeObj) );
        return (jlong)(new Ptr<cv::dnn::TextDetectionModel_DB>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
  ...
  (JNIEnv* env, jclass , jstring model, jstring config)
{
    ...
    try {
        ...
        Ptr<cv::dnn::TextDetectionModel_DB> _retval_ = makePtr<cv::dnn::TextDetectionModel_DB>( n_model, n_config );
        return (jlong)(new Ptr<cv::dnn::TextDetectionModel_DB>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jstring model)
{
    ...
    try {
        LOGD("%s", method_name);
        const char* utf_model = env->GetStringUTFChars(model, 0); std::string n_model( utf_model ? utf_model : "" ); env->ReleaseStringUTFChars(model, utf_model);
        Ptr<cv::dnn::TextDetectionModel_DB> _retval_ = makePtr<cv::dnn::TextDetectionModel_DB>( n_model );
        return (jlong)(new Ptr<cv::dnn::TextDetectionModel_DB>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jfloat binaryThreshold)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::dnn::TextDetectionModel_DB>* me = (Ptr<cv::dnn::TextDetectionModel_DB>*) self; //TODO: check for NULL
...
//
//  native support for java finalize()
//  static void Ptr<cv::dnn::TextDetectionModel_DB>::delete( __int64 self )
//
...
JNIEXPORT void JNICALL Java_org_opencv_dnn_TextDetectionModel_1DB_delete
  (JNIEnv*, jclass, jlong self)
{
    delete (Ptr<cv::dnn::TextDetectionModel_DB>*) self;
}
  ...
  (JNIEnv* env, jclass , jlong network_nativeObj)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::dnn::TextDetectionModel_EAST> _retval_ = makePtr<cv::dnn::TextDetectionModel_EAST>( (*(cv::dnn::Net*)network_nativeObj) );
        return (jlong)(new Ptr<cv::dnn::TextDetectionModel_EAST>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
  ...
  (JNIEnv* env, jclass , jstring model, jstring config)
{
    ...
    try {
        ...
        const char* utf_model = env->GetStringUTFChars(model, 0); std::string n_model( utf_model ? utf_model : "" ); env->ReleaseStringUTFChars(model, utf_model);
        const char* utf_config = env->GetStringUTFChars(config, 0); std::string n_config( utf_config ? utf_config : "" ); env->ReleaseStringUTFChars(config, utf_config);
        Ptr<cv::dnn::TextDetectionModel_EAST> _retval_ = makePtr<cv::dnn::TextDetectionModel_EAST>( n_model, n_config );
        return (jlong)(new Ptr<cv::dnn::TextDetectionModel_EAST>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jstring model)
{
    ...
    try {
        LOGD("%s", method_name);
        const char* utf_model = env->GetStringUTFChars(model, 0); std::string n_model( utf_model ? utf_model : "" ); env->ReleaseStringUTFChars(model, utf_model);
        Ptr<cv::dnn::TextDetectionModel_EAST> _retval_ = makePtr<cv::dnn::TextDetectionModel_EAST>( n_model );
        return (jlong)(new Ptr<cv::dnn::TextDetectionModel_EAST>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jfloat confThreshold)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::dnn::TextDetectionModel_EAST>* me = (Ptr<cv::dnn::TextDetectionModel_EAST>*) self; //TODO: check for NULL
...
//
//  native support for java finalize()
//  static void Ptr<cv::dnn::TextDetectionModel_EAST>::delete( __int64 self )
//
...
JNIEXPORT void JNICALL Java_org_opencv_dnn_TextDetectionModel_1EAST_delete
  (JNIEnv*, jclass, jlong self)
{
    delete (Ptr<cv::dnn::TextDetectionModel_EAST>*) self;
}
  ...
  (JNIEnv* env, jclass , jlong network_nativeObj)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::dnn::TextRecognitionModel> _retval_ = makePtr<cv::dnn::TextRecognitionModel>( (*(cv::dnn::Net*)network_nativeObj) );
        return (jlong)(new Ptr<cv::dnn::TextRecognitionModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
  ...
  (JNIEnv* env, jclass , jstring model, jstring config)
{
    ...
    try {
        ...
        const char* utf_model = env->GetStringUTFChars(model, 0); std::string n_model( utf_model ? utf_model : "" ); env->ReleaseStringUTFChars(model, utf_model);
        const char* utf_config = env->GetStringUTFChars(config, 0); std::string n_config( utf_config ? utf_config : "" ); env->ReleaseStringUTFChars(config, utf_config);
        Ptr<cv::dnn::TextRecognitionModel> _retval_ = makePtr<cv::dnn::TextRecognitionModel>( n_model, n_config );
        return (jlong)(new Ptr<cv::dnn::TextRecognitionModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jstring model)
{
    ...
    try {
        LOGD("%s", method_name);
        const char* utf_model = env->GetStringUTFChars(model, 0); std::string n_model( utf_model ? utf_model : "" ); env->ReleaseStringUTFChars(model, utf_model);
        Ptr<cv::dnn::TextRecognitionModel> _retval_ = makePtr<cv::dnn::TextRecognitionModel>( n_model );
        return (jlong)(new Ptr<cv::dnn::TextRecognitionModel>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jstring decodeType)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::dnn::TextRecognitionModel>* me = (Ptr<cv::dnn::TextRecognitionModel>*) self; //TODO: check for NULL
...
//
//  native support for java finalize()
//  static void Ptr<cv::dnn::TextRecognitionModel>::delete( __int64 self )
//
...
JNIEXPORT void JNICALL Java_org_opencv_dnn_TextRecognitionModel_delete
  (JNIEnv*, jclass, jlong self)
{
    delete (Ptr<cv::dnn::TextRecognitionModel>*) self;
}
