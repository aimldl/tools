...
#include "/home/k8smaster/github/tools/yolov3/bash_scripts/opencv-master/../opencv_contrib-master/modules/aruco/include/opencv2/aruco.hpp"
#include "/home/k8smaster/github/tools/yolov3/bash_scripts/opencv-master/../opencv_contrib-master/modules/aruco/include/opencv2/aruco/charuco.hpp"
#include "/home/k8smaster/github/tools/yolov3/bash_scripts/opencv-master/../opencv_contrib-master/modules/aruco/include/opencv2/aruco/dictionary.hpp"
...
JNIEXPORT jboolean JNICALL Java_org_opencv_aruco_Aruco_testCharucoCornersCollinear_10
  (JNIEnv* env, jclass , jlong _board_nativeObj, jlong _charucoIds_nativeObj)
{
    
    static const char method_name[] = "aruco::testCharucoCornersCollinear_10()";
    try {
        LOGD("%s", method_name);
        Mat& _charucoIds = *((Mat*)_charucoIds_nativeObj);
        return cv::aruco::testCharucoCornersCollinear( *((Ptr<cv::aruco::CharucoBoard>*)_board_nativeObj), _charucoIds );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
